...
export const UI_STRINGS = {
  ...
  "nav.profile": "Profile",
  "nav.trips": "Trips",
  // Trips (Phase 1 — list + create/rename/delete; see trips.tsx)
  "trips.badge": "Trip planner",
  "trips.title1": "Your",
  "trips.title2": "trips",
  "trips.sub": "Group saved places into journeys — plan the days, listen on the road.",
  "trips.new": "New trip",
  "trips.cancel": "Cancel",
  "trips.namePh": "Trip name — e.g. Rome in September",
  "trips.start": "Start",
  "trips.end": "End",
  "trips.create": "Create trip",
  "trips.creating": "Creating…",
  "trips.empty": "No trips yet",
  "trips.emptyDesc": "Create your first trip, then add places to it from search or any attraction page.",
  "trips.places.one": "1 place",
  "trips.places.many": "{n} places",
  "trips.rename": "Rename",
  "trips.renamePh": "New name",
  "trips.delete": "Delete trip",
  "trips.deleteConfirm": "Delete this trip? The places themselves stay in your Saved library.",
  "trips.signInTitle": "Sign in to plan trips",
  "trips.signInDesc": "Trips sync with your account, so your plans follow you on every device.",
  "trips.loadFailed": "Couldn't load your trips. Check the connection and try again.",
  "trips.retry": "Try again",
  "trips.emptyTrip": "This trip is empty",
  "trips.emptyTripDesc": "Find a place in search and add it to this trip when saving.",
  "trips.findPlaces": "Find places",
  // Trips (Phase 2 — add-to-trip sheet + item list)
  "trips.addToTrip": "Add to a trip?",
  "trips.addedTo": "Added to {name}",
  "trips.addFailed": "Couldn't add to the trip. Try again.",
  "trips.skip": "Not now",
  "trips.listenEstimate": "~{n} min of audio",
  "trips.removeItem": "Remove from trip",
  // Trips (Phase 3 — day plan)
  "trips.day": "Day {n}",
  "trips.anytime": "Anytime",
  "trips.addDay": "Add day",
  "trips.moveToDay": "Move to a day",
  "trips.dayEmpty": "Nothing planned for this day yet.",
  "trips.reorder": "Reorder",
  "trips.viewDays": "Days",
  "trips.viewCities": "Cities",
  // Trips (Phase 5 — sharing)
  "trips.share": "Share trip",
  "trips.stopShare": "Stop sharing",
  "trips.linkCopied": "Link copied",
  "trips.shareHint": "Anyone with this link can view the trip.",
  "trips.sharedTrip": "Shared trip",
  ...
  "toast.removedFromOffline": "Removed from offline",
  ...
  "set.deleteAccountBlurb": "Permanently removes your account and all your data from Lokali.",
  "set.deleteConfirmTitle": "Delete your account?",
  "set.deleteConfirmBody": "This action cannot be undone. The following will be permanently removed:",
  "set.deleteConfirmBullet1": "Your sign-in credentials and profile",
  "set.deleteConfirmBullet2": "All saved tours from this device and the cloud",
  "set.deleteConfirmBullet3": "All offline-downloaded audio and scripts",
  "set.deleteConfirmYes": "Delete my account",
  "set.deleteConfirmCancel": "Cancel",
  "set.deletingAccount": "Deleting…",
  "set.deleteFailedTitle": "Couldn't delete account",
  "set.deleteFailedDesc": "Something went wrong. Try again, or contact support if it persists.",
  "set.deleteFailedSession": "Your session expired. Sign in again, then try once more.",
  "set.deleteSuccessTitle": "Account deleted",
  "set.deleteSuccessDesc": "Your account and all data have been removed.",
  ...
  "attr.savedNoAudioTitle": "Saved — but audio didn't download",
  "attr.savedNoAudioDesc": "Reconnect and tap Save again to retry the offline audio download.",
