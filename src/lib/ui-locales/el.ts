...
export const EL: Partial<Record<UiKey, string>> = {
  ...
  "hero.bangkok.country": "Ταϊλάνδη",
  "hero.bangkok.city": "Μπανγκόκ",
  "hero.bangkok.tagline2": "η Πόλη των Αγγέλων",
  "hero.bangkok.blurb":
    "Κανάλια κλονγκ και επίχρυσοι ναοί, γουόκ του δρόμου που πετούν σπίθες και ο Τσάο Πράγια να λάμπει πίσω από τις long-tail βάρκες στο σούρουπο.",
  "hero.london.country": "Ηνωμένο Βασίλειο",
  "hero.london.city": "Λονδίνο",
  "hero.london.tagline2": "ο Τάμεσης",
  "hero.london.blurb":
    "Μαύρα ταξί στη βροχή, κυριακάτικες καμπάνες στο Ουέστμινστερ και αιώνες αυτοκρατορίας στοιβαγμένοι κατά μήκος ενός ποταμού που ακόμη συνδέει τα πάντα.",
