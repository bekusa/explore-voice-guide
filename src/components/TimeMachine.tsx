...
const ROLES: Role[] = [
  { value: "merchant", label: "Merchant", hint: "Trades everywhere, moves freely", emoji: "💰" },
  {
    value: "soldier",
    label: "Soldier / Guard",
    hint: "Present at every gate, every era",
    emoji: "⚔️",
  },
  { value: "servant", label: "Servant", hint: "Sees everything, says little", emoji: "🧹" },
  {
    value: "foreigner",
    label: "Foreign Traveler",
    hint: "Questions are natural, nothing ordinary",
    emoji: "🧭",
  },
  ...
  { value: "healer", label: "Healer", hint: "Needed in war and peace alike", emoji: "🌿" },
  {
    value: "spy",
    label: "Spy / Informant",
    hint: "Trusts no one, notices everything",
    emoji: "🕵️",
  },
                        ...
                        <div className="border-t border-border px-4 pb-4 pt-4">
                          ...
                          <div className="mt-4">
                            ...
                            >
                              <span
                                className={
                                  roles[a.id] ? "text-foreground" : "text-muted-foreground"
                                }
                              >
                                {roles[a.id]
